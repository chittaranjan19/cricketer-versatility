...
#This script scrapes the ODI records of all matches India have played at home.
#Minor changes to scrape away matches.

page = urlopen("http://howstat.com/cricket/Statistics/Series/SeriesListCountry_ODI.asp?A=IND&B=XXX&W=H#odis")
soup = BeautifulSoup(page)

odiWickets = open("odiWicketsHome.csv",'w') 	#CHANGE TO X WHEN SCRAPING AWAY MATCHES
odiRuns = open("odiRunsHome.csv",'w')
